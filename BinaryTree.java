...
public class BinaryTree {
    ...
    private void replaceValueHelper(Node node, int oldVal, int newVal) {
        ...
        replaceValueHelper(node.left, oldVal, newVal); // recursion left
        replaceValueHelper(node.right, oldVal, newVal); // recursion right
    }
    ...
    private int nodesGTHelper(Node node, int val) {
        ...
        count += nodesGTHelper(node.left, val); // recursion
